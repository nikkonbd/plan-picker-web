      ...
      <div className="ms-10">
        ...
        <Tabs>
          <TabList className="flex pb-2 border-b-2">
            <Tab className="w-48">
              <Link>Hours & Preferences</Link>
            </Tab>
            <Tab className="w-48">
              <Link>Connected Calenders</Link>
            </Tab>
            <Tab className="w-48">
              <Link>Holidays</Link>
            </Tab>
          ...
          <TabPanel className="w-auto me-12">
            ...
            <p className="mt-3 mb-2 font-medium">
              Set default hours used for new events or events you're co-hosting
              with your team
            </p>
            <WeeklyHoursForm />
          </TabPanel>
          <TabPanel className="me-12">
            ...
            <div className="p-5 border-2 rounded-lg">
              <div className="flex justify-between">
                <p className="text-xl">
                  My Calender Account{" "}
                  <span className="text-blue-gray-400">1/6</span>
                </p>
                <button className="px-2 py-2 text-white rounded bg-light-blue-600">
          ...
          <TabPanel>
            ...
            <p className="mb-5 w-[32rem]">
              Calendly automatically removes certain holidays from your
              availability{" "}
              <span className="font-bold">on all your Event Types</span> based
              on your country. You can choose which holidays you observe here.
            </p>

            <p className="bg-blue-gray-50 p-4 rounded-lg w-[32rem]">
              <span className="font-bold">Tip:</span> Don’t see a holiday you
              observe? Add an all-day, busy, or out-of-office event to your
              connected calendar to prevent Calendly from booking that date.
            </p>

            <div className="w-auto border-2 rounded-lg mt-7 me-16">
              <div className="py-3 border-b ps-3">
                <p className="text-sm font-normal text-blue-gray-400">
                  COUNTRY USED FOR HOLIDAYS
                </p>
                <p>
                  <span className="font-normal text-black">Other</span>{" "}
