...
const MorePlan = () => {
    ...
    return (
        <div className='px-4 md:px-0 md:w-8/12 mx-auto'>
            {
               scheduleDetails.map((plan, idx) => <div key={idx} className="flex flex-col-reverse items-center justify-between gap-4 mt-12 md:flex lg:flex lg:flex-row md:flex-row">
               <div data-aos="fade-up-right">
                   <div className="text-center md:text-start">
                       <h2 className="text-4xl font-medium">
                           {plan.title}
                       </h2>
                       <p className="py-4 lg:w-[500px] ">
                           {plan.description}
                       </p>
                   </div>
               ...
               <div data-aos="fade-up-left">
                   <img className="rounded-xl w-full h-full md:h-[400px] md:w-[600px]" src={plan.img} alt="" />
               </div>
           </div>) 
            }
        </div>
