...
const Blog = () => {
  ...
  return (
    <div className="md:w-8/12 mx-auto text-[#61677A]">
      {/* banner */}
      <div className="md:flex justify-between items-center min-h-[60vh] my-10">
        <div className="md:w-1/2 px-4 md:px-0">
          <h1 className="md:text-5xl text-3xl font-semibold pb-2 text-[#5EBEC4]">
            Journey to Success: <br /> <span className="text-base text-[#42a6ad]">Unleash Your Potential Through Articles Our Articles</span>
          </h1>
      ...
      <div className="my-10">
        <div className="py-5">
        <h1 className="text-center font-semi-bold md:text-6xl text-3xl">
          Explore our top articles
        </h1>
        <p className="text-center text-base">This is our Top article section</p>
        </div>
