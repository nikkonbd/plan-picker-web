...
const Contact = () => {
  return (
    <div>
      ...
      <div className="flex flex-col md:flex-row gap-4 md:w-8/12 mx-auto px-4 md:px-0">
        <div className="border-2 p-4 text-center shadow hover:shadow-lg mb-4 md:mb-0 mt-4 md:mt-0">
          ...
          <p className="py-2">Talk to our sales team about purchasing Calendly for your team request friendly</p>
        ...
        <div className="border-2 p-4 text-center shadow mb-4 md:mb-0 hover:shadow-lg">
          ...
          <p className="py-2">Submit a request to get help from our friendly support experts request friendly </p>
          <a href="#" className="inline-block pt-6 pb-10 md:pt-0 md:pb-0 mt-4">
            <Button
              variant="text"
              className="flex text-white items-center gap-2 bg-[#5EBEC4] hover:bg-[#42a6ad]"
        ...
        <div className="border-2 p-4 text-center mb-4 md:mb-0 shadow hover:shadow-lg">
          ...
          <p className="py-2">Read helpful articles, watch tutorials, and get help with Calendly request friendly</p>
          <a href="#" className="inline-block pt-6 pb-10 md:pt-0 md:pb-0 mt-4">
            <Button
              variant="text"
              className="flex text-white items-center gap-2 bg-[#5EBEC4] hover:bg-[#42a6ad]"
        ...
        <div className="border-2 p-4 text-center shadow hover:shadow-lg">
            <p><FaConnectdevelop className="text-4xl"></FaConnectdevelop></p>
          <h2 className="text-2xl font-semibold pt-4">Media & Press</h2>
          <p className="py-2">Download Calendly’s press kit, read press releases, and request interviews</p>
          <a href="#" className="inline-block pt-6 pb-10 md:pt-0 md:pb-0 mt-4">
            <Button
              variant="text"
              className="flex text-white items-center gap-2 bg-[#5EBEC4] hover:bg-[#42a6ad]"
      ...
      <div className="text-[#61677A] text-center py-20 px-4 md:px-0">
        ...
        <p>Need some content about joining us in a partner or career adventure!</p>
      </div>
      <div className="md:w-8/12 mx-auto md:flex gap-6 px-4 md:px-0">
      <div className="border-2 p-4 shadow hover:shadow-lg">
            <FaConnectdevelop className="text-4xl"></FaConnectdevelop>
          <h2 className="text-2xl font-semibold pt-4">Join Our Team</h2>
          <p className="py-2">Interesting in applying for a position? View our Careers page for open positions and apply.</p>
          <a href="#" className="inline-block pt-6 pb-10 md:pt-0 md:pb-0 mt-4">
            <Button
              variant="text"
              className="flex text-white items-center gap-2 bg-[#5EBEC4] hover:bg-[#42a6ad]"
