    ...
    <div>
      ...
      <div className="flex flex-col items-center gap-10 pb-20 mt-10 md:flex-row md:gap-10">
        <div className="w-full mx-auto space-y-2">
          <div><h2 className="text-4xl font-semibold ">Get in Touch</h2>
        ...
        <div className="w-full">
          <form ref={form} onSubmit={sendEmail} className="flex flex-col w-screen px-4 space-y-3 md:w-full md:px-0 ">
            <input
              type="text"
              name="from_name"
